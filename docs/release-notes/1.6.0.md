...
- Replacing `WindowChrome` and related things with reference to `ControlzEx` [#3021](https://github.com/MahApps/MahApps.Metro/pull/3021)
  + Adds `KeepBorderOnMaximize` property to `MetroWindow` to fix [#2729](https://github.com/MahApps/MahApps.Metro/issues/2729). Defaults to `True`. 
...
- [#2855](https://github.com/MahApps/MahApps.Metro/issues/2825) Maximize Window with Animations On and Max Width/Height Fails
