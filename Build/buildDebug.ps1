...
. $env:windir\Microsoft.NET\Framework\$version\MSBuild.exe $proj /t:Rebuild /ToolsVersion:4.0 /p:StrongName=False /p:configuration=Debug /m /v:q /p:BUILD_NUMBER=$build_number
