...
namespace MetroDemo.Core
{
    ...
    /// theme leaves them barely readable. So Styles/Xaml.xshd is loaded with the palette of the base
    ...
    public sealed class XamlSyntaxHighlighting : INotifyPropertyChanged
    {
        ...
        private void Reload()
        {
            ...
            using var resource = assembly.GetManifestResourceStream("MetroDemo.Styles.Xaml.xshd");
            if (resource is null)
            {
                return;
            }
