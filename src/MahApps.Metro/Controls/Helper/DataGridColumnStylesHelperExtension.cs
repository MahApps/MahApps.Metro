        ...
        protected virtual void BindColumnStyles(DataGridColumn column)
        {
            ...
            switch (column)
            {
                ...
                case DataGridNumericUpDownColumn numericUpDownColumn:
                    ...
                    break;
                case DataGridDecimalUpDownColumn decimalUpDownColumn:
                    SetBinding(decimalUpDownColumn, DataGridBoundColumn.ElementStyleProperty, dataGrid, DataGridHelper.AutoGeneratedDecimalUpDownColumnStyleProperty);
                    SetBinding(decimalUpDownColumn, DataGridBoundColumn.EditingElementStyleProperty, dataGrid, DataGridHelper.AutoGeneratedDecimalUpDownColumnEditingStyleProperty);
                    break;
                case DataGridIntegerUpDownColumn integerUpDownColumn:
                    SetBinding(integerUpDownColumn, DataGridBoundColumn.ElementStyleProperty, dataGrid, DataGridHelper.AutoGeneratedIntegerUpDownColumnStyleProperty);
                    SetBinding(integerUpDownColumn, DataGridBoundColumn.EditingElementStyleProperty, dataGrid, DataGridHelper.AutoGeneratedIntegerUpDownColumnEditingStyleProperty);
                    break;
                case DataGridLongUpDownColumn longUpDownColumn:
                    SetBinding(longUpDownColumn, DataGridBoundColumn.ElementStyleProperty, dataGrid, DataGridHelper.AutoGeneratedLongUpDownColumnStyleProperty);
                    SetBinding(longUpDownColumn, DataGridBoundColumn.EditingElementStyleProperty, dataGrid, DataGridHelper.AutoGeneratedLongUpDownColumnEditingStyleProperty);
                    break;
        ...
        protected virtual void ClearColumnStyles(DataGridColumn column)
        {
            ...
            switch (column)
            {
                ...
                case DataGridNumericUpDownColumn numericUpDownColumn:
                    ...
                    break;
                case DataGridDecimalUpDownColumn decimalUpDownColumn:
                    ClearBinding(decimalUpDownColumn, DataGridBoundColumn.ElementStyleProperty, dataGrid, DataGridHelper.AutoGeneratedDecimalUpDownColumnStyleProperty);
                    ClearBinding(decimalUpDownColumn, DataGridBoundColumn.EditingElementStyleProperty, dataGrid, DataGridHelper.AutoGeneratedDecimalUpDownColumnEditingStyleProperty);
                    break;
                case DataGridIntegerUpDownColumn integerUpDownColumn:
                    ClearBinding(integerUpDownColumn, DataGridBoundColumn.ElementStyleProperty, dataGrid, DataGridHelper.AutoGeneratedIntegerUpDownColumnStyleProperty);
                    ClearBinding(integerUpDownColumn, DataGridBoundColumn.EditingElementStyleProperty, dataGrid, DataGridHelper.AutoGeneratedIntegerUpDownColumnEditingStyleProperty);
                    break;
                case DataGridLongUpDownColumn longUpDownColumn:
                    ClearBinding(longUpDownColumn, DataGridBoundColumn.ElementStyleProperty, dataGrid, DataGridHelper.AutoGeneratedLongUpDownColumnStyleProperty);
                    ClearBinding(longUpDownColumn, DataGridBoundColumn.EditingElementStyleProperty, dataGrid, DataGridHelper.AutoGeneratedLongUpDownColumnEditingStyleProperty);
                    break;
                case DataGridHyperlinkColumn hyperlinkColumn:
